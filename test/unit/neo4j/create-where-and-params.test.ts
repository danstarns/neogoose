...
describe("neo4j/createWhereAndParams", () => {
  ...
  describe("functionality", () => {
    ...
    it("should return correct where clause and params with $ne", () => {
      const id = generate({
        charset: "alphabetic",
      });
    ...
    it("should return correct where clause and params with $nin", () => {
      const id = generate({
        charset: "alphabetic",
      });
      ...
      expect(w.where).to.contain(`WHERE ( NOT n.id IN $node.${id})`);
