# neogoose
Node.js [Neo4j](https://neo4j.com/) OGM inspired by [Mongoose](https://github.com/Automattic/mongoose) & [GraphQL](https://graphql.org/)
...
## Selection Set
Select more than [Autogenerated Selection Set](#autogenerated-selection-set) works well with [Resolvers](#resolvers) and complex nested types, Used with;
